...
const faculties = [
  { name: "Картография и геоинформатика", requiredScores: { math: 39, russian: 40, informatics: 44, geography: 40 } },
  { name: "Экология и природопользование", requiredScores: { math: 39, russian: 40, informatics: 44, geography: 40 } },
  { name: "Архитектура", requiredScores: { math: 39, russian: 40, picture: 40, composition: 40 } },
  { name: "Дизайн архитектурной среды", requiredScores: { math: 39, russian: 40, picture: 40, composition: 40 } },
  { name: "Строительство", requiredScores: { math: 39, russian: 40, chemistry: 39, physics: 39 } },
  { name: "Строительство уникальных зданий и сооружений", requiredScores: { math: 39, russian: 40, physics: 39 } },
  { name: "Информатика и вычислительная техника", requiredScores: { math: 39, russian: 40, informatics: 44, physics: 39 } },
  { name: "Информационные системы и технологии", requiredScores: { math: 39, russian: 40, informatics: 44 } },
  { name: "Прикладная информатика", requiredScores: { math: 39, russian: 40, informatics: 44 } },
  { name: "Инфокоммуникационные технологии и системы связи", requiredScores: { math: 39, russian: 40, informatics: 44, physics: 39 } }
  ...
  const calculateTotal = () => {
    ...
    const eligible = faculties.filter(faculty => {
      return Object.keys(faculty.requiredScores).every(subject => 
        ...
        (scores.physics && Number(scores.physics) >= 39) || (scores.informatics && Number(scores.informatics) >= 44)
      );
    });
